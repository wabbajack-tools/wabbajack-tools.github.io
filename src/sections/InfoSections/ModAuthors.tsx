...
export default () => (
  ...
  >
    ...
    <Typography>
      ...
      to retrieve download links from the Nexus. Downloads using the API are the
      same as direct downloads from the Nexus meaning this will count towards
      your download count and give you donation points.
    </Typography>
    <Typography variant="subtitle1" style={{ marginTop: '8px' }}>
      How can I opt out of having my mod be included in a Modlist?
    </Typography>
    <Typography>
      We use the official Nexus API to download mods. Everyone who has access to
      the Nexus can download your mod. The Nexus does not lock out API access
      based on <i>author preferences</i>.
    </Typography>
    <Typography variant="subtitle1" style={{ marginTop: '8px' }}>
    ...
    <Typography>
      ...
      access to the manifest of the Modlist. This contains a list of all mods to
      be installed as well as the authors, version, size, links and more meta
      data depending on origin.
      <br />
      ...
      <br />
      After installation the user most likely needs to check the instructions of
      the Modlist for recommended MCM options. If your mod has an MCM and needs
      a lot of configuring than your mod will likely be featured in the
      instructions.
      <br />
      Some Modlists have an extensive README that contains a section dedicated
      to some of the important mods in the setup with links to the mod page and
      mod author page.
    </Typography>
    <Typography variant="subtitle1" style={{ marginTop: '8px' }}>
    ...
    <Typography>
      ...
      mods on. Even if the site does not have an API or requires a login, we can
      always just resort to our internal browser and download the mod as if a
      user would go to the website using Firefox/Chrome and click the download
      button.
    </Typography>
  </Container>
);
